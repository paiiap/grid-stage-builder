(function initCore(root, factory) {
  ...
  const DEFAULT_ROOM_DEFINITIONS = [
    { id: "living_room", name: "Living Room", type: "living_room", color: "#2f8f73", terrain: "indoor_floor" },
    { id: "kitchen", name: "Kitchen", type: "kitchen", color: "#c27a34", terrain: "indoor_floor" },
    { id: "dining_room", name: "Dining Room", type: "dining_room", color: "#b69535", terrain: "indoor_floor" },
    { id: "bedroom", name: "Bedroom", type: "bedroom", color: "#5e82c4", terrain: "indoor_floor" },
    { id: "bathroom", name: "Bathroom", type: "bathroom", color: "#4aa0b5", terrain: "indoor_floor" },
    { id: "cat_room", name: "Cat Room", type: "cat_room", color: "#b0659f", terrain: "indoor_floor" },
    { id: "garden", name: "Garden", type: "garden", color: "#4f9b58", terrain: "garden" },
    { id: "balcony", name: "Balcony", type: "balcony", color: "#9f7b4f", terrain: "outdoor_ground" }
  ];
